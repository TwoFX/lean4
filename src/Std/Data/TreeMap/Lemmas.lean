...
variable {α : Type u} {β : Type v} {γ : Type w} {δ : Type w} {cmp : α → α → Ordering} {t : TreeMap α β cmp}
...
theorem beq_iff_equiv [TransCmp cmp] [LawfulEqCmp cmp] [LawfulBEq β] : (m₁ == m₂) ↔ m₁ ~m m₂ :=
